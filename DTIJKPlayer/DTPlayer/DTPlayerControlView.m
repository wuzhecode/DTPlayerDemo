...
@interface DTPlayerControlView () <UIGestureRecognizerDelegate>
...
- (void)makeSubViewsConstraints
{
    ...
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.trailing.equalTo(self.topImageView).offset(-10);
    }];
...
- (ASValueTrackingSlider *)videoSlider
{
    if (!_videoSlider) {
        ...
        _videoSlider.minimumTrackTintColor = DTColor(82,216,227, 1);
...
#pragma mark - Public method - 通过关联的方式可以它的代理能够调用这些方法
/** 重置ControlView */
...
/** 设置播放模型 */
- (void)zf_playerModel:(DTPlayerModel *)playerModel
{
